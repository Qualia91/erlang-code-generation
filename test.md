...
This is an Extension for Visual Studio Code to generate some boilerplate code for you Erlang projects. Its currently under development. Feel free to create pull requests for anything you think would be useful!
...
- [Modules](#modules)
	...
	- [Gen State Machine](#gen_state_machine)
	- [Header](#header)
	- [CT](#ct)
	- [EScript](#escript)
	- [Lager Handler](#lager_handler)
	- [Poolboy Worker](#poolboy_worker)
	- [Cowboy Rest Handler](#cowboy_rest_handler)
	- [Cowboy Websocket Handler](#cowboy_websocket_handler)
